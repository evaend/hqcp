...
@BaseSql(tableName="TD_SELECT_SCOPE", resultName="com.phxl.hqcp.dao.SelectScopeMapper.BaseResultMap")
public class SelectScope {
    private String selectScopeGuid;
    ...
    private String selectScopeSubType;

    public String getSelectScopeGuid() {
        return selectScopeGuid;
    }

    public void setSelectScopeGuid(String selectScopeGuid) {
        this.selectScopeGuid = selectScopeGuid == null ? null : selectScopeGuid.trim();
    }
    ...
    public void setSelectOrgId(Long selectOrgId) {
    ...
    public String getSelectScopeSubType() {
        return selectScopeSubType;
    }

    public void setSelectScopeSubType(String selectScopeSubType) {
        this.selectScopeSubType = selectScopeSubType == null ? null : selectScopeSubType.trim();
    }
}